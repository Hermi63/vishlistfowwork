...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 glass animate-slide-down">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
        ...
        >
          ...
          <span className="tracking-tight text-zinc-100">WishList</span>
        </Link>
        <div className="flex items-center gap-3">
          {user ? (
            ...
            <>
              <Link href="/login">
                <Button variant="ghost" size="sm" className="text-zinc-400 hover:text-zinc-100">Войти</Button>
              </Link>
              <Link href="/register">
